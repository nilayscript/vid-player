      ...
      <div className="bg-[rgba(0,0,0,0.8)] w-[28rem] flex flex-col items-center justify-center py-3 rounded-[4px]">
        ...
        <div className="p-6 w-full">
          ...
          <div>
            <div
              onClick={handleLogin}
              className="cursor-pointer flex items-center justify-center bg-[#E50914] text-white h-[2.8rem] rounded-[4px]"
            >
              Sign In
            </div>
            <h1 className="text-[10px] text-[#B3B3B3] my-3 font-[400]">
              Need help? Connect with us at support@digisigns.in
            </h1>
          </div>
        </div>
        <div className="flex items-center justify-between p-6 gap-12">
          <h1 className="text-[15px] text-[#B3B3B3] my-3 font-[400]">
            New to Digisigns? Go to https://www.digisigns.in to sign up & set up
            your digital signages right now.
          </h1>
